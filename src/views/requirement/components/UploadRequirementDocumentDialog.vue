<template>
  ...
  >
    ...
    >
      ...
      <t-form-item
          label="需求文档"
          name="upload_requirement_document_file"
      >
        <t-upload
...
const handle_confirm = async () => {
  ...
  request.post(API_URLS.requirements_document.upload, submit_form_data)
      .then((res) => {
